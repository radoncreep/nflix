...
export function BrowseContainer({ slides }) {
    ...
    // spinner loader when you click/pick a profile which was initially empty
    useEffect(() => {
        setTimeout(() => {
            setLoading(false);
        }, 3000);
    ...
    return profile.displayName ? (
        <>
            ...
            <Header src="joker1" dontShowOnSmallViewPort>
                <Header.Frame>
                    <Header.Group>
                        <Header.Logo to={ROUTES.HOME} src={logo} alt="Netflix Logo"></Header.Logo>
                        <Header.TextLink 
                ...
                <Header.Feature>
                    ...
                    <Header.Text>
                        ...
                        wears two
                        masks -- the one he paints for his day job as a clown,
                        and the guise
