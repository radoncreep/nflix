export function seedDatabase(firebase) {
    // --- explanation 
    // the UUID function is used to generate an Id for each data collection object
    function getUUID() { 
    ...
    /* Series
      ============================================ */
    // Documentaries
    // ---- explanation --- .fireStore() is creating a store for the initialized web app
    // and the collection method is used to create a db collection in the store of the web app
    // the collection method accepts a string tha is used to name each collection
    // while add takes in an object of data which is added to that collection
    firebase.firestore().collection('series').add({
      id: getUUID(), // each id property calls the uuid function and a custom id is generated for it
      title: 'Tiger King',
